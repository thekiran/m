        ...
        const submit = () => {
                ...
                const {depart_name,
                    email_add,
                    tele_no,adresse,postcode,city,
                    dest,dp1598335005261,timeset,
                    snum,inlineRadio1,
                    inlineRadio2,
                    inlineRadio3,
                    inlineRadio4,
            ...
            else if(value === '04 Alpes de Hautes-Provence') return 'cpamtaxiconventionne@gmail.com'
               ...
               sub.addEventListener('click', e => {
                ...
                function sendEmail(){
                    // console.log(form.depart_name.value)
                        if (form.depart_name.value= 0 || form.email_add.value == '' || form.adresse.value == ''||
                        form.postcode == '' 
                            // || city,
                            // dest, 
                            // snum, 
                            ...
                            return; 
                           } else if(form.depart_name.value.lenght> 1){
                            Email.send({
                                Host : "smtp.gmail.com",
                                Username : "dummymailofkiran@gmail.com",
                                Password : "VTnuiDvAEPYD74M",
                                To : depart(depart_name.value),
                                From : "dummymailofkiran@gmail.com",
                                Subject : "This is the data",
                                Body : body
                            }).then(
                            message => alert('Your request is Successful')
                            );
                           }
